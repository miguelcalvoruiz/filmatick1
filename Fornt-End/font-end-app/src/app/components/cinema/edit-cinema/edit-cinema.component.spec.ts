...
describe('EditCinemaComponent', () => {
  ...
  it('should load cinema data on init', () => {
    const cinemaData = { id: 1, name: 'Cinema Name', latitude: 0, longitude: 0 };
    cinemasService.getById.and.returnValue(of(cinemaData));
  ...
  it('should save changes successfully', () => {
    ...
    const cinemaData: cinemaDTO = { id: 1, ...cinema }; // Mock cinema data with ID
    component.model = cinemaData; // Set model with ID
    cinemasService.edit.and.returnValue(of(null as any));
